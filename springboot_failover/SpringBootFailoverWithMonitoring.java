...
public class SpringBootFailoverWithMonitoring {
    ...
    private static final String TEST_ID = "SPRINGBOOT-FAILOVER-" + System.currentTimeMillis();
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            String newConnTag1 = extractFullConnTag(conn1.connection);
            String newConnTag2 = extractFullConnTag(conn2.connection);
            ...
            if (!newConnTag1.equals(conn1.fullConnTag) || !newConnTag2.equals(conn2.fullConnTag)) {
                ...
                conn1.afterFailoverConnTag = extractFullConnTag(conn1.connection);
                conn2.afterFailoverConnTag = extractFullConnTag(conn2.connection);
