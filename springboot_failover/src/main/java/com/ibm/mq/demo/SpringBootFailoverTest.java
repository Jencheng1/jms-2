...
/**
 * Spring Boot CONNTAG Extraction Test
 * Demonstrates the Spring Boot approach vs Regular JMS
 */
public class SpringBootFailoverTest {
    ...
    public static String extractFullConnTag(Connection connection) {
        try {
            // Lines 16-24: Try direct property extraction using Spring Boot approach
            ...
            if (connection instanceof MQConnection) {
                ...
                if (conntag != null && !conntag.isEmpty()) {
                    // Line 27: Return full CONNTAG without truncation
                    return conntag;  // Format: MQCT<16-char-handle><QM>_<timestamp>
                }
            }
            
            // Lines 32-47: Fallback using reflection if direct access fails
     ...
     * Lines 62-80: Session CONNTAG extraction
     */
    public static String extractSessionConnTag(Session session) {
        try {
            // Lines 67-71: Sessions inherit parent's CONNTAG
            ...
            if (session instanceof MQSession) {
                ...
                if (conntag != null) {
                    // Line 76: Return inherited CONNTAG (same as parent)
                    return conntag;
                }
            }
        } catch (Exception e) {
